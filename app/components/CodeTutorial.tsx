...
export default function CodeTutorial() {
  ...
  useCopilotReadable({"description": "Code to display to user", "value":codeToDisplay});
  useCopilotAction(
    {
    ...
    <>
      <main className=" min-h-screen px-4">
        ...
        <div className="w-10/12 mx-auto">
          <div className="mt-8">
            <h1 className="text-black text-center text-xl font-semibold p-6">
              Code Tutorial
            </h1>
            {codeTutorial ? (
              <Markdown className="text-black">{codeTutorial}</Markdown>
            ) : (
